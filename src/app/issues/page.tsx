        ...
        <DashboardLayout>
          <div className="flex items-center justify-center h-64">
            <motion.div
              ...
              className="rounded-full h-12 w-12 border-4 border-t-red-500 border-r-red-200/20 border-b-red-200/20 border-l-red-200/20 dark:border-t-red-400 dark:border-r-red-800/20 dark:border-b-red-800/20 dark:border-l-red-800/20"
            />
          </div>
        </DashboardLayout>
      </ProtectedRoute>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
              <div className="space-y-3">
                ...
                <p className="text-base text-gray-600 dark:text-gray-400 flex items-center gap-2 max-w-2xl">
                  ...
                  Track, triage, and resolve issues with precision and clarity
                </p>
              </div>
              <motion.div
            ...
            {(
              ...
              >
                ...
                <div className="relative text-center">
                  ...
                  <p className={`text-3xl font-bold bg-gradient-to-br ${colors.from} ${colors.to} bg-clip-text text-transparent`}>{(stats.byStatus as any)[key]}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          {filteredIssues && filteredIssues.length > 0 ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50/80 dark:bg-white/5 backdrop-blur-sm border-b border-gray-200/50 dark:border-white/10">
                      <tr>
                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Issue</th>
                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Project</th>
                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Reporter</th>
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-center">
                            <select
                              ...
                              className={`text-xs font-semibold px-3 py-1.5 rounded-full ${statusColors[issue.status]} cursor-pointer hover:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-white/20`}
                            >
                              <option value="OPEN">Open</option>
                              <option value="IN_PROGRESS">In Progress</option>
                              <option value="RESOLVED">Resolved</option>
            ...
            >
              ...
              <motion.div
                ...
                className="relative"
              >
                <AlertTriangle className="h-20 w-20 text-gray-300 dark:text-gray-700 mx-auto mb-6" />
              </motion.div>
        ...
        <div className="relative">
          <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex items-center gap-2 mb-1">
                <span className="inline-flex items-center justify-center w-6 h-6 text-xs font-bold bg-gradient-to-br from-gray-700 to-gray-800 dark:from-gray-400 dark:to-gray-500 text-white dark:text-gray-900 rounded-md shadow-sm">
                  {issue.id}
                </span>
                <span className={`inline-flex px-2 py-0.5 rounded-md text-[10px] font-semibold ${statusColors[issue.status]}`}>
                  {issue.status.replace('_', ' ')}
                </span>
              </div>
              <h4 className="text-sm font-semibold text-gray-900 dark:text-white line-clamp-2 leading-relaxed">
                {issue.description}
              </h4>
            </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-200/50 dark:border-white/5">
            ...
            <div className="inline-flex items-center gap-1.5 px-2 py-1 bg-gray-100/80 dark:bg-white/5 rounded-md">
              ...
              <span className="text-xs font-medium text-gray-600 dark:text-gray-400 truncate max-w-[80px]">
