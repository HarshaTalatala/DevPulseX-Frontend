                ...
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="bg-white dark:bg-neutral-950 rounded-lg border border-gray-200 dark:border-neutral-800 p-4 sm:p-5">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="h-9 w-9 sm:h-10 sm:w-10 bg-gray-100 dark:bg-neutral-900 rounded-lg animate-pulse" />
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[700px]">
                    <thead className="bg-gray-50 dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral-800">
                      <tr>
                        {['ID', 'Team Name', 'Members', 'Team Members', 'Actions'].map((header, i) => (
                        ...
                        <tr key={i}>
                          ...
                          <td className="px-3 sm:px-6 py-3 sm:py-4">
                            <div className="flex gap-1">
                              <div className="h-5 w-16 bg-gray-100 dark:bg-neutral-900 rounded animate-pulse" />
                              <div className="h-5 w-16 bg-gray-100 dark:bg-neutral-900 rounded animate-pulse" />
                              <div className="h-5 w-16 bg-gray-100 dark:bg-neutral-900 rounded animate-pulse" />
                            </div>
                          </td>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6">
              <div className="space-y-2">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black dark:text-white">Collaborate together</h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 hover:border-gray-400 dark:hover:border-neutral-600 transition-all duration-200">
              <div className="flex items-center justify-between">
                ...
                <div className="p-2 sm:p-2.5 bg-gray-100 dark:bg-neutral-900 rounded-lg">
                  <Users className="h-5 w-5 sm:h-6 sm:w-6 text-black dark:text-white"/>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 hover:border-gray-400 dark:hover:border-neutral-600 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-black dark:text-white mt-2">{metrics.totalMembers}</p>
                </div>
                <div className="p-2 sm:p-2.5 bg-gray-100 dark:bg-neutral-900 rounded-lg">
                  <UserCheck className="h-5 w-5 sm:h-6 sm:w-6 text-black dark:text-white"/>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 hover:border-gray-400 dark:hover:border-neutral-600 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-black dark:text-white mt-2">{metrics.avgTeamSize}</p>
                </div>
                <div className="p-2 sm:p-2.5 bg-gray-100 dark:bg-neutral-900 rounded-lg">
                  <TrendingUp className="h-5 w-5 sm:h-6 sm:w-6 text-black dark:text-white"/>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg p-4 sm:p-5 hover:border-gray-400 dark:hover:border-neutral-600 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-black dark:text-white mt-2">{metrics.largestTeam}</p>
                </div>
                <div className="p-2 sm:p-2.5 bg-gray-100 dark:bg-neutral-900 rounded-lg">
                  <UserPlus className="h-5 w-5 sm:h-6 sm:w-6 text-black dark:text-white"/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 lg:items-end lg:justify-between">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Button 
                  ...
                  onClick={() => { setSearch(''); setMemberFilter('ALL'); setSortKey('name'); setSortDir('asc'); setPage(1); }}
                >
                  Reset
                </Button>
              </div>
          ...
          <div className="bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-800 rounded-lg overflow-hidden">
            {isError && (
              <div className="m-4 p-4 rounded-lg border border-gray-200 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-900 text-black dark:text-white flex items-center justify-between">
                <span className="font-medium text-xs sm:text-sm">Failed to load teams. Please try again.</span>
              ...
              <table className="w-full min-w-[700px]">
                <thead className="bg-gray-50 dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral-800">
                  <tr>
                    ...
                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-medium text-gray-600 dark:text-neutral-400 uppercase tracking-wider cursor-pointer hover:text-black dark:hover:text-white transition-colors" onClick={() => changeSort('members')}>
                      Members {sortKey==='members' ? (sortDir==='asc' ? '↑' : '↓') : ''}
                    </th>
                    <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-medium text-gray-600 dark:text-neutral-400 uppercase tracking-wider">Team Members</th>
                ...
                {filtered.length === 0 ? (
                  <tr>
                    <td colSpan={5}>
                      <div className="text-center py-12 sm:py-16">
                        <Users className="h-10 w-10 sm:h-12 sm:w-12 text-gray-300 dark:text-neutral-700 mx-auto mb-3" />
                  ...
                  pageData.map((team) => (
                    <tr key={team.id} className="hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                      ...
                      <td className="px-3 sm:px-6 py-3 sm:py-4 font-medium text-xs sm:text-sm text-black dark:text-white truncate max-w-[120px] sm:max-w-none">{team.name}</td>
                      <td className="px-3 sm:px-6 py-3 sm:py-4">
                        <span className="inline-flex items-center px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs font-medium border bg-black dark:bg-white border-black dark:border-white text-white dark:text-black">
                          {team.memberIds.length} <span className="hidden sm:inline">{team.memberIds.length === 1 ? 'member' : 'members'}</span>
                        </span>
                      </td>
                      <td className="px-3 sm:px-6 py-3 sm:py-4">
                        <div className="flex flex-wrap gap-1 max-w-[200px] sm:max-w-md">
                          {team.memberIds.length > 0 ? (
                            team.memberIds.slice(0, 5).map((memberId) => (
                              <span
                                key={memberId}
                                className="inline-flex items-center px-1.5 sm:px-2 py-0.5 rounded text-[10px] sm:text-xs bg-gray-100 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 text-gray-700 dark:text-neutral-300 truncate max-w-[80px] sm:max-w-none"
                              >
                                {getUserName(memberId)}
                              </span>
                            ))
                          ) : (
                            <span className="text-[10px] sm:text-xs text-gray-500 dark:text-neutral-500 italic">No members</span>
                          )}
